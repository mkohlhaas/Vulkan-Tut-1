...
static void bindPipeline() { vkCmdBindPipeline(cmdBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline); }
...
static void draw() { vkCmdDraw(cmdBuffer, 3, 1, 0, 0); }

static void endRenderPass() { vkCmdEndRenderPass(cmdBuffer); }
